...
impl VerificationShare {
    pub fn new<C: Verification>(
        ...
        if threshold < 2 || threshold > coefficient_commitments.len() {
        ...
        let verification_share = unsafe {
            ...
            ret = ffi::secp256k1_frost_compute_pubshare(
                ...
                coefficient_commitment_ptrs.as_c_ptr(),
                coefficient_commitments.len(),
            );
            verification_share
        };
    ...
    pub fn verify<C: Verification>(
        ...
        let ret = unsafe {
            ffi::secp256k1_frost_share_verify(
                ...
                participant_id.serialize().as_c_ptr(),
                self.as_c_ptr(),
                &coefficient_commitment.as_c_ptr() as *const *const ffi::PublicKey,
            )
        };
