...
} rustsecp256k1zkp_v0_10_0_frost_keygen_cache;
...
} rustsecp256k1zkp_v0_10_0_frost_share;
...
} rustsecp256k1zkp_v0_10_0_frost_secnonce;
...
} rustsecp256k1zkp_v0_10_0_frost_pubnonce;
...
} rustsecp256k1zkp_v0_10_0_frost_session;
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_0_frost_pubnonce_parse(
    const rustsecp256k1zkp_v0_10_0_context *ctx,
    rustsecp256k1zkp_v0_10_0_frost_pubnonce *nonce,
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_0_frost_pubnonce_serialize(
    const rustsecp256k1zkp_v0_10_0_context *ctx,
    unsigned char *out66,
    const rustsecp256k1zkp_v0_10_0_frost_pubnonce *nonce
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_0_frost_partial_sig_serialize(
    const rustsecp256k1zkp_v0_10_0_context *ctx,
    unsigned char *out32,
    const rustsecp256k1zkp_v0_10_0_frost_partial_sig *sig
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_0_frost_partial_sig_parse(
    const rustsecp256k1zkp_v0_10_0_context *ctx,
    rustsecp256k1zkp_v0_10_0_frost_partial_sig *sig,
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_0_frost_share_serialize(
    const rustsecp256k1zkp_v0_10_0_context *ctx,
    unsigned char *out32,
    const rustsecp256k1zkp_v0_10_0_frost_share *share
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_0_frost_share_parse(
    const rustsecp256k1zkp_v0_10_0_context *ctx,
    rustsecp256k1zkp_v0_10_0_frost_share *share,
    const unsigned char *in32
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 *                        unique to this call to rustsecp256k1zkp_v0_10_0_frost_shares_gen
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_0_frost_shares_gen(
    const rustsecp256k1zkp_v0_10_0_context *ctx,
    rustsecp256k1zkp_v0_10_0_frost_share *shares,
    rustsecp256k1zkp_v0_10_0_pubkey *vss_commitment,
    unsigned char *pok64,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_10_0_frost_share_verify(
    const rustsecp256k1zkp_v0_10_0_context *ctx,
    size_t threshold,
    const unsigned char *id33,
    const rustsecp256k1zkp_v0_10_0_frost_share *share,
 ...
 * agg_vss_commitment: the output of `rustsecp256k1zkp_v0_10_0_frost_share_agg`
 *     n_participants: the total number of participants
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_0_frost_compute_pubshare(
    const rustsecp256k1zkp_v0_10_0_context *ctx,
    rustsecp256k1zkp_v0_10_0_pubkey *pubshare,
    size_t threshold,
    const unsigned char *id33,
    const rustsecp256k1zkp_v0_10_0_pubkey *agg_vss_commitment,
    size_t n_participants
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_10_0_frost_pubkey_gen(
    const rustsecp256k1zkp_v0_10_0_context *ctx,
 ...
 *                    `frost_pubkey_gen`
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_10_0_frost_pubkey_get(
    const rustsecp256k1zkp_v0_10_0_context *ctx,
 ...
 *  earlier failures).
 *
 *  rustsecp256k1zkp_v0_10_0_frost_pubkey_gen(..., keygen_cache, ...)
 *  rustsecp256k1zkp_v0_10_0_frost_pubkey_tweak(..., keygen_cache, xonly_pk)
 *  rustsecp256k1zkp_v0_10_0_frost_pubkey_ec_tweak_add(..., output_pk, keygen_cache, tweak32)
 *  rustsecp256k1zkp_v0_10_0_ec_pubkey_serialize(..., buf, output_pk)
 *  rustsecp256k1zkp_v0_10_0_frost_pubkey_get(..., ec_pk, xonly_pk)
 *  rustsecp256k1zkp_v0_10_0_ec_pubkey_tweak_add(..., ec_pk, tweak32)
 *  rustsecp256k1zkp_v0_10_0_ec_pubkey_serialize(..., buf2, ec_pk)
 *
 ...
 *                        2^128).
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_10_0_frost_pubkey_ec_tweak_add(
    const rustsecp256k1zkp_v0_10_0_context *ctx,
 ...
 *
 *  rustsecp256k1zkp_v0_10_0_frost_pubkey_gen(..., keygen_cache, ..., ..., ...)
 *  rustsecp256k1zkp_v0_10_0_frost_pubkey_xonly_tweak_add(..., output_pk, keygen_cache, tweak32)
 *  rustsecp256k1zkp_v0_10_0_xonly_pubkey_serialize(..., buf, output_pk)
 *  rustsecp256k1zkp_v0_10_0_frost_pubkey_get(..., pk, keygen_cache)
 *  rustsecp256k1zkp_v0_10_0_xonly_pubkey_tweak_add_check(..., buf, ..., pk, tweak32)
 *
 *  This function is required if you want to _sign_ for a tweaked group key.
 *  On the other hand, if you are only computing a public key, but not intending
 *  to create a signature for it, you can just use
 ...
 *                        2^128).
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_10_0_frost_pubkey_xonly_tweak_add(
    const rustsecp256k1zkp_v0_10_0_context *ctx,
    rustsecp256k1zkp_v0_10_0_pubkey *output_pubkey,
    rustsecp256k1zkp_v0_10_0_frost_keygen_cache *keygen_cache,
    const unsigned char *tweak32
 ...
 *                     unique to this call to rustsecp256k1zkp_v0_10_0_frost_nonce_gen and
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_0_frost_nonce_gen(
    const rustsecp256k1zkp_v0_10_0_context *ctx,
    rustsecp256k1zkp_v0_10_0_frost_secnonce *secnonce,
    rustsecp256k1zkp_v0_10_0_frost_pubnonce *pubnonce,
    const unsigned char *session_id32,
    const rustsecp256k1zkp_v0_10_0_frost_share *agg_share,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_10_0_frost_nonce_process(
    const rustsecp256k1zkp_v0_10_0_context *ctx,
    rustsecp256k1zkp_v0_10_0_frost_session *session,
    const rustsecp256k1zkp_v0_10_0_frost_pubnonce * const *pubnonces,
    size_t n_pubnonces,
    const unsigned char *msg32,
 ...
 *        keygen_cache: pointer to frost_keygen_cache struct
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_0_frost_partial_sign(
    const rustsecp256k1zkp_v0_10_0_context *ctx,
    rustsecp256k1zkp_v0_10_0_frost_partial_sig *partial_sig,
    rustsecp256k1zkp_v0_10_0_frost_secnonce *secnonce,
    const rustsecp256k1zkp_v0_10_0_frost_share *agg_share,
    const rustsecp256k1zkp_v0_10_0_frost_session *session,
    const rustsecp256k1zkp_v0_10_0_frost_keygen_cache *keygen_cache
 ...
 *       `rustsecp256k1zkp_v0_10_0_frost_compute_pubshare` for the signer's ID.
 ...
 *                    `rustsecp256k1zkp_v0_10_0_frost_compute_pubshare`
 *           session: pointer to the session that was created with
 *                    `frost_nonce_process`
 *       keygen_cache: pointer to frost_keygen_cache struct
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_10_0_frost_partial_sig_verify(
    const rustsecp256k1zkp_v0_10_0_context *ctx,
    const rustsecp256k1zkp_v0_10_0_frost_partial_sig *partial_sig,
    const rustsecp256k1zkp_v0_10_0_frost_pubnonce *pubnonce,
    const rustsecp256k1zkp_v0_10_0_pubkey *pubshare,
    const rustsecp256k1zkp_v0_10_0_frost_session *session,
    const rustsecp256k1zkp_v0_10_0_frost_keygen_cache *keygen_cache
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3) SECP256K1_ARG_NONNULL(4) SECP256K1_ARG_NONNULL(5) SECP256K1_ARG_NONNULL(6);
 ...
 *                     greater than 0.
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_0_frost_partial_sig_agg(
    const rustsecp256k1zkp_v0_10_0_context *ctx,
    unsigned char *sig64,
    const rustsecp256k1zkp_v0_10_0_frost_session *session,
    const rustsecp256k1zkp_v0_10_0_frost_partial_sig * const *partial_sigs,
    size_t n_sigs
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3) SECP256K1_ARG_NONNULL(4);
 ...
 *                     frost_nonce_process
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_0_frost_nonce_parity(
    const rustsecp256k1zkp_v0_10_0_context *ctx,
    int *nonce_parity,
    const rustsecp256k1zkp_v0_10_0_frost_session *session
) SECP256K1_ARG_NONNULL(1) SECP256K1_ARG_NONNULL(2) SECP256K1_ARG_NONNULL(3);
 ...
 */
SECP256K1_API int rustsecp256k1zkp_v0_10_0_frost_verify_adaptor(
    const rustsecp256k1zkp_v0_10_0_context *ctx,
 ...
 *                     session used for producing the pre-signature
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_10_0_frost_adapt(
    const rustsecp256k1zkp_v0_10_0_context *ctx,
    unsigned char *sig64,
    const unsigned char *pre_sig64,
 ...
 */
SECP256K1_API SECP256K1_WARN_UNUSED_RESULT int rustsecp256k1zkp_v0_10_0_frost_extract_adaptor(
    const rustsecp256k1zkp_v0_10_0_context *ctx,
