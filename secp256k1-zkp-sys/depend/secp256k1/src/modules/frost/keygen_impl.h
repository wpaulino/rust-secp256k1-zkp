...
/* See RFC 9591 */
static int rustsecp256k1zkp_v0_10_0_frost_vss_verify_internal(const rustsecp256k1zkp_v0_10_0_context* ctx, size_t threshold, const unsigned char *id33, const rustsecp256k1zkp_v0_10_0_scalar *share, const rustsecp256k1zkp_v0_10_0_pubkey * const* vss_commitment) {
...
int rustsecp256k1zkp_v0_10_0_frost_share_verify(const rustsecp256k1zkp_v0_10_0_context* ctx, size_t threshold, const unsigned char *id33, const rustsecp256k1zkp_v0_10_0_frost_share *share, const rustsecp256k1zkp_v0_10_0_pubkey * const* vss_commitment) {
    rustsecp256k1zkp_v0_10_0_scalar share_i;
...
int rustsecp256k1zkp_v0_10_0_frost_compute_pubshare(const rustsecp256k1zkp_v0_10_0_context* ctx, rustsecp256k1zkp_v0_10_0_pubkey *pubshare, size_t threshold, const unsigned char *id33, const rustsecp256k1zkp_v0_10_0_pubkey * const* vss_commitments, size_t n_participants) {
    rustsecp256k1zkp_v0_10_0_gej pkj;
    rustsecp256k1zkp_v0_10_0_ge tmp;
    rustsecp256k1zkp_v0_10_0_frost_compute_pubshare_ecmult_data compute_pubshare_ecmult_data;
    ...
    /* Evaluate the public polynomial at the idx */
    if (!rustsecp256k1zkp_v0_10_0_frost_compute_indexhash(&compute_pubshare_ecmult_data.idx, id33)) {
        return 0;
    }
    rustsecp256k1zkp_v0_10_0_scalar_set_int(&compute_pubshare_ecmult_data.idxn, 1);
    /* TODO: add scratch */
    if (!rustsecp256k1zkp_v0_10_0_ecmult_multi_var(&ctx->error_callback, NULL, &pkj, NULL, rustsecp256k1zkp_v0_10_0_frost_compute_pubshare_ecmult_callback, (void *) &compute_pubshare_ecmult_data, n_participants*threshold)) {
        return 0;
    }
    rustsecp256k1zkp_v0_10_0_ge_set_gej(&tmp, &pkj);
